...
public final class SAOHud {
    ...
    public static void renderLowHpVignette(GuiGraphics g, int w, int h, float hpFrac) {        if (hpFrac >= 0.2f || hpFrac <= 0f) {
            return;
        }
    ...
    public static int teamRows(Minecraft mc) {
        if (!SAOConfig.showHud() || !com.sao.saomenu.client.party.SAOClientPartyState.inParty()) {
            return 0;
        }
